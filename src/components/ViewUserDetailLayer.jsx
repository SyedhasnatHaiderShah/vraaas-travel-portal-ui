...
const ViewUserDetailLayer = () => {
  ...
  const readURL = (input) => {
    setSelectFile(input.target.files[0]);
  ...
  const onSubmit = async () => {
    try {
      ...
      updatedData.append("file", selectFile);

      const response = await axios.post(
        `http://localhost:3000/user/profile-picture/${localStorage.getItem(
          "username"
        )}`,
        updatedData,
        {
              ...
              <div className="tab-content" id="pills-tabContent">
                ...
                >
                  <div className="form-switch switch-primary py-12 px-16 border radius-8 position-relative mb-16">
                    ...
                    />
                    <div className="d-flex align-items-center gap-3 justify-content-between mb-12">
                  ...
                  <div className="form-switch switch-primary py-12 px-16 border radius-8 position-relative mb-16">
                    ...
                    <InsuranceUpload title="Upload Insurance" />
                  </div>
                  <div className="form-switch switch-primary py-12 px-16 border radius-8 position-relative mb-16">
                    <label
                    ...
                    <TicketUpload title="Upload Ticket" />
                  </div>
                  <div className="form-switch switch-primary py-12 px-16 border radius-8 position-relative mb-16">
                    <label
                      htmlFor="meetUp"
                    ...
                    <HotelBookingUpload title="Upload Hotel Booking" />
                  </div>
                  <div className="form-switch switch-primary py-12 px-16 border radius-8 position-relative mb-16">
                    <label
                    ...
                    <ItineraryUpload title="Upload Itinerary" />
                  </div>
                </div> */}
              </div>
            </div>
