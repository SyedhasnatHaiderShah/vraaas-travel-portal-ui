...
const CreateTransportServices = ({ transportService }) => {
        ...
        <div className="max-w-500-px mx-md-auto mx-0 w-100">
          <div>
            ...
            <p className="mb-32 text-secondary-light text-lg">
              Following fields can used to update Transport Company Service with
              the id {}.
            </p>
          </div>
          <form action="#" onSubmit={handleSubmit(onSubmit)} className="w-100">
            <div className="col-12">
              ...
              <div className="icon-field has-validation">
                ...
                <input
                  ...
                  min={1}
                  max={1000}
                  defaultValue={transportService.transport_company_id}
            ...
            <div className="col-12">
              ...
              <div className="icon-field has-validation">
                ...
                <input
                  ...
                  defaultValue={transportService.from_city.from_city_id}
                  required=""
            ...
            <div className="col-12">
              ...
              <div className="icon-field has-validation">
                ...
                <input
                  ...
                  defaultValue={transportService.to_city.to_city_id}
                  required=""
                  {...register("to_city_id", {
                    required: "from city id is required",
                  })}
            ...
            <div className="col-12">
              ...
              <input
                ...
                defaultValue={new Date(
                  transportService.departure_time
                ).toLocaleString()}
                required=""
            ...
            <div className="col-12">
              ...
              <select
                ...
                defaultValue={
                  transportService.is_partner === true ? "true" : "false"
                }
              >
            ...
            <div className="col-12">
              ...
              <select
                ...
                defaultValue={
                  transportService.active === true ? "true" : "false"
                }
              >
