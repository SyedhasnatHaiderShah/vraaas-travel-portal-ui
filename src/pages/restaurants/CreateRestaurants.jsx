        ...
        <div className="auth-right py-10 px-24 w-100">
          <div className="max-w-500-px mx-md-auto mx-0 w-100">
            <div>
              ...
              <h4 className="mb-12">Create Restaurant </h4>
              <p className="mb-32 text-secondary-light text-lg">
                {" "}
                Following are the fields required to create a new Restaurant.
              </p>
            </div>
            <form
              action="#"
            ...
            >
              <div className=" col-12">
                <label className="form-label">Restaurants Name</label>
              ...
              <div className=" col-12">
                <label className="form-label">Restaurants Address</label>
                <div className="icon-field has-validation">
                  <span className="icon">
                    <Icon icon="f7:person" />
                  </span>
                  <textarea
                    ...
                    className="form-control"
                    placeholder="Enter Restaurants Address"
                    required=""
                    {...register("address", {
                ...
                <div className="icon-field has-validation">
                  ...
                  <input
                    ...
                    {...register("cuisine_type", {
                      required: "cuisine_type is required",
                    })}
                  />
