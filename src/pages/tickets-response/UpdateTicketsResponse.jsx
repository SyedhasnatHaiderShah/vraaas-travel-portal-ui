  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:3000/ticket-responses/${updateData.response_id}/update`,
        data,
        {
          headers: {
        ...
        <div className="max-w-500-px mx-md-auto mx-0 w-100">
          <div>
            ...
            <p className="mb-32 text-secondary-light text-lg">
              {" "}
              Following are the fields required to create a new ticket response.
            </p>
          </div>
          <form
            action="#"
...
export default UpdateTicketsResponse;
